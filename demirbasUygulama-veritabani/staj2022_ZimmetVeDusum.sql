...
CREATE TABLE `ZimmetVeDusum` (
  ...
  `zimmetlenenTarih` date NOT NULL,
  `durum` varchar(20) NOT NULL,
  `zimmetDusumTarihi` date DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `FK_personelID` (`personelID`),
  KEY `FK_demirbasID_idx` (`demirbasID`),
  CONSTRAINT `FK_demirbasID` FOREIGN KEY (`demirbasID`) REFERENCES `DemirbasYonetimi` (`ID`),
  CONSTRAINT `FK_personelID` FOREIGN KEY (`personelID`) REFERENCES `PersonelYonetimi` (`ID`)
...
-- Dump completed on 2022-08-26 16:05:53
